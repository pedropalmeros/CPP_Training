...
class Graph {
    ...
    public:
        ...
        bool removeVertex(string vertex){
            //cout << "adjList.count(vertex): " << adjList.count(vertex)  << endl; 
            auto otherVetexes = adjList.at(vertex); 
            //for(auto element : otherVetexes){
            //    cout << "Elment:" << element << endl; 
            //}

            for(auto otherVertex : adjList.at(vertex)){
                //cout << " otherVertex: " << otherVertex << endl; 
